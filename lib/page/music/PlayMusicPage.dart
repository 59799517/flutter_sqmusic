...
//循环模式图标
                                        ...
                                        onPressed: () {
                                          if(isopenalidrive()){
                                            ...
                                            if(isLike.value){
                                              ...
                                              deltoalidrive("我喜欢的歌曲").then((value) => {
                                                //刷新歌单
                                                AliClient.RefresPlayListByNameInfo("我喜欢的歌曲"),
                                                aliDriveController.RefresPlayListByNameInfo("我喜欢的歌曲")
                                              });
                                            }else{
                                              //标记为喜欢的
                                              isLike.value=true;
                                              //修改图标
                                              setState(() {
                                                isLikeIcon=Icon(LineIcons.heart,color: Colors.red,);
                                              });
                                              uploadtoalidrive("我喜欢的歌曲").then((value) => {
                                                //添加失败
                                                if(!value){
                                                  isLike.value=false,
                                                  setState(() {
                                                  ...
                                                  //刷新歌单
                                                  aliDriveController.RefresPlayListByNameInfo("我喜欢的歌曲").then((value) => {
                                                  })
                                                }
                                              });
                                            }
                                            ...
                                            OtherUtils.showToast("请打开云盘功能后使用。");
                                          }
                                        },
                                      ),
                                      Obx(() => IconButton(
                                            ...
                                            onPressed: () {
                                              loopint++;
                                              loopint.value = loopint.value % 3;
                                              controller.assetsAudioPlayer!
                                                  .setLoopMode(LoopMode
                                                      .values[loopint.value]);
                                              OtherUtils.showToast(
                                                  loopint.value == 0
                                                      ...
                                                      : loopint.value == 1
                                                          ? "单曲循环"
                                                          : "列表循环");
                                              SpUtil.putInt(SetKey.PLAY_SONG_LOOP, loopint.value);
                                            },
                                          )),
                                      IconButton(
                                        icon: Icon(
                                            ...
                                            Alert(
                                                ...
                                                content: StatefulBuilder(
                                                    builder: (context, wpsetState) {
                                                      ...
                                                      int group=0;
                                                      for (var playname in  SpUtil.getObject(SetKey.ALI_MUSICDIR)!.keys) {
                                                       if(playname=="我喜欢的歌曲"){
                                                         continue;
                                                       }
                                                       groupvaluenamelist[group]=playname;
                                                       playListWidget.add(
                                                            Container(
                                                              height: 50,
                                                              child: Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  GFRadio(
                                                                    ...
                                                                    type: GFRadioType.custom,
                                                                      activeIcon:Icon(LineIcons.check,color: GFColors.SUCCESS,),
                                                                    value:group,
                                                                    groupValue: groupValue.value,
                                                                    onChanged: (value) {
                                                                      print(groupValue.value);
                                                                      wpsetState((){
                                                                        groupValue.value = int.parse(value.toString());
                                                ...
                                                buttons: [
                                                  ...
                                                  DialogButton(
                                                    onPressed: () {
                                                      Get.back();
                                                      //查看是否有该歌曲
                                                      Map data = aliDriveController.aliPlayList.value[SpUtil.getObject(SetKey.ALI_MUSICDIR)![groupvaluenamelist[groupValue.value]]];
                                                      if(data.containsKey(musicname+" - "+artist)){
                                                        //有该歌曲
                                                        OtherUtils.showToast("歌曲已经存在");
                                                      }else{
                                                        uploadtoalidrive(groupvaluenamelist[groupValue.value]).then((value) => {
        ...
        listenPlayMusic()
            ...
            kugwocontroller
              ...
              kugwocontroller
                  ...
                  brvalue: SpUtil.getString(SetKey.PLAY_SONG_QUALITY)!)
                  .then((musicplayurl) => {
                //获取下载链接
  ...
  Future<bool> uploadtoalidrive(String musicPlayName) async {
   return await AliClient.addSongToAliDrive(MusicInfo: songdata,file_id:  SpUtil.getObject(SetKey.ALI_MUSICDIR)![musicPlayName]);
  }
  //删除云盘歌曲
